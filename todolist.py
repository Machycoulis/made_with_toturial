...
#_______CREATE_WINDOW_______#

root = tkinter.Tk()
root.title("Wake-up and to things!")
...
button_save_tasks = tkinter.Button(root, text="Save tasks", width=48,
                                 command=save_tasks)
